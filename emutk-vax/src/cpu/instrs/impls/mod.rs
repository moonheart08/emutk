        ...
        let itable: [Option<fn(&mut VAXCPU<'_, T> , &mut Cycles) -> Result<(), Error>>; 1280]
         = gen_instr_table!{
            VAX_INSTR_MAP_TABLE; 1280; Option<fn(&mut VAXCPU<'_, T> , &mut Cycles) -> Result<(), Error>>; None => {
                ...
                0x3C => MOVZWL, Some(misc::instr_noimpl);
                ...
                0x7A => EMUL, Some(misc::instr_noimpl);
                ...
                0x84 => MULB2, Some(misc::instr_noimpl);
                0x85 => MULB3, Some(misc::instr_noimpl);
                0x86 => DIVB2, Some(misc::instr_noimpl);
                0x87 => DIVB3, Some(misc::instr_noimpl);
                0x88 => BISB2, Some(misc::instr_noimpl);
                0x89 => BISB3, Some(misc::instr_noimpl);
                0x8A => BICB2, Some(misc::instr_noimpl);
                0x8B => BICB3, Some(misc::instr_noimpl);
                0x8C => XORB2, Some(misc::instr_noimpl);
                0x8D => XORB3, Some(misc::instr_noimpl);
                ...
                0x93 => BITB, Some(misc::instr_noimpl);
                0x94 => CLRB, Some(misc::instr_clr::<_, u8>);
                0x95 => TSTB, Some(misc::instr_noimpl);
                ...
                0x9A => MOVZBL, Some(misc::instr_noimpl);
                0x9B => MOVZBW, Some(misc::instr_noimpl);
                ...
                0xA4 => MULW2, Some(misc::instr_noimpl);
                0xA5 => MULW3, Some(misc::instr_noimpl);
                0xA6 => DIVW2, Some(misc::instr_noimpl);
                0xA7 => DIVW3, Some(misc::instr_noimpl);
                0xA8 => BISW2, Some(misc::instr_noimpl);
                0xA9 => BISW3, Some(misc::instr_noimpl);
                0xAA => BICW2, Some(misc::instr_noimpl);
                0xAB => BICW3, Some(misc::instr_noimpl);
                0xAC => XORW2, Some(misc::instr_noimpl);
                0xAD => XORW3, Some(misc::instr_noimpl);
                ...
                0xB3 => BITW, Some(misc::instr_noimpl);
                0xB4 => CLRW, Some(misc::instr_clr::<_, u16>);
                0xB5 => TSTW, Some(misc::instr_noimpl);
                0xB6 => INCW, Some(arith::instr_inc::<_, u16>);
                0xB7 => DECW, Some(arith::instr_dec::<_, u16>);
                0xB8 => BISPSW, Some(misc::instr_noimpl);
                0xB9 => BISPSW, Some(misc::instr_noimpl);
                ...
                0xC6 => DIVL2, Some(misc::instr_noimpl);
                0xC7 => DIVL3, Some(misc::instr_noimpl);
                0xC8 => BISL2, Some(misc::instr_noimpl);
                0xC9 => BISL3, Some(misc::instr_noimpl);
                0xCA => BICL2, Some(misc::instr_noimpl);
                0xCB => BICL3, Some(misc::instr_noimpl);
                0xCC => XORL2, Some(misc::instr_noimpl);
                0xCD => XORL3, Some(misc::instr_noimpl);
                ...
                0xD3 => BITL, Some(misc::instr_noimpl);
